                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="input-group mb-3">
                                                                                    ...
                                                                                    <input type="text" name="id_card" value="{{old('id_card',$employee->id_card)}}" class="form-control" placeholder="Id card" aria-label="Id card" aria-describedby="basic-addon1">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="input-group mb-3">
